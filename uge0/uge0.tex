...
\textbf{Lokale: 5522-131 Undervisningslokale}
s
\textbf{Tidspunkt: 10:00-12:00}
...
{\center \LARGE Aflevering 0\par}
\vspace{2em}

{\LARGE Navn: Anders Andersen\par}
\vspace{2em}

{\LARGE Studienummer: 12345678\par}
\vspace{2em}
...
\begin{equation}
    \begin{aligned}
         ...
         -2x_1 + 2\mu - 2x_2 + 2\mu - 4x_3 + 8\mu = 0\\
    \iff \dfrac{2x_1 + 2x_2 + 4x_3}{12} = \dfrac{x_1 + x_2 + 2x_3}{6} = \mu .
        \end{aligned}
\end{equation}
